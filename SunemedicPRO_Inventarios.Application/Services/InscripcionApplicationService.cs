...
using SunemedicPRO_Inventarios.Server.Application.DTOs;
...
namespace SunemedicPRO_Inventarios.Server.Application.Services
{
    public class InscripcionApplicationService : IInscripcionApplicationService
    {
        ...
        public async Task CrearAsync(InscripcionCreateDto dto)
        {
            ...
            {
                throw new ApiException(StatusCodes.Status409Conflict, "La inscripción no pudo completarse por concurrencia. Intenta nuevamente.");
            }
        }
        ...
        public async Task DeleteAsync(int inscripcionId)
        {
            ...
            {
                throw new ApiException(StatusCodes.Status404NotFound, "Inscripción no encontrada.");
            }

            if (inscripcion.EstudianteId != estudiante.Id)
            {
                throw new ApiException(StatusCodes.Status403Forbidden, "No puedes eliminar esta inscripción.");
            }
