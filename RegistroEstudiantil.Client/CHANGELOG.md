...
- Create Angular project with ng: `ng new RegistroEstudiantil.Client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`RegistroEstudiantil.Client.esproj`).
