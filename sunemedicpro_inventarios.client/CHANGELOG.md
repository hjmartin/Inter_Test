...
- Create Angular project with ng: `ng new sunemedicpro_inventarios.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`sunemedicpro_inventarios.client.esproj`).
